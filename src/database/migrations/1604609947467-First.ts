...
export class First1604609947467 implements MigrationInterface {
    name = 'First1604609947467'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "lesson" ADD CONSTRAINT "FK_ac7f90322d2d395243ffc6d9250" FOREIGN KEY ("sessionId") REFERENCES "session"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "lesson" DROP CONSTRAINT "FK_ac7f90322d2d395243ffc6d9250"`);
